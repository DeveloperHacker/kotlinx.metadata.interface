...
class KtFileFacade(environment: KtEnvironment, javaElement: Element, metadata: KotlinClassMetadata.FileFacade) :
    KtClassElement<KotlinClassMetadata.FileFacade>(environment, javaElement, metadata) {
